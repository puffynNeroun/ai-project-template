...
forge_run_verify_summary "/tmp/forge-operator-create-completion-pr-before-verify.log"
...
forge_run_verify_summary "/tmp/forge-operator-create-completion-pr-after-verify.log"
