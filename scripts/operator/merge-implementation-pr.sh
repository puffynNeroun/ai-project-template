...
forge_run_verify_summary "/tmp/forge-operator-merge-implementation-pr-before-verify.log"
...
forge_run_verify_summary "/tmp/forge-operator-merge-implementation-pr-main-verify.log"
