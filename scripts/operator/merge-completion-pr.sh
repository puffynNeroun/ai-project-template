...
forge_run_verify_summary "/tmp/forge-operator-merge-completion-pr-before-verify.log"
...
forge_run_verify_summary "/tmp/forge-operator-merge-completion-pr-main-verify.log"
